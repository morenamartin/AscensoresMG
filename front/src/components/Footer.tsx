...
const Footer = () => {
    return (
        <div className="w-full bg-[#1A2F47] h-fit px-24 pb-6">
            <div className="grid grid-cols-[400px_2fr_2fr] gap-16 py-10">
                <div>
                ...
                <div>
                    <h1 className="pt-4 text-lg font-bold text-white">Información de Contacto</h1>

    ...
    return (
        <div className="flex flex-col items-center pb-12">
            ...
            <div className="grid grid-cols-4 gap-20">
                <Image src={sweet} alt="sweet" width={180}/>
                <Image src={flexelo} alt="flexelo" width={180}/>
                <Image src={signotel} alt="signotel" width={180}/>
                <Image src={sutecba} alt="sutecba" width={180}/>
            </div>
